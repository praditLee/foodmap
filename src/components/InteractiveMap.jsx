...
export default function InteractiveMap({ allLocations }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 min-h-[600px]">
      ...
      <div className="flex-1 bg-white rounded-xl shadow-sm p-4 relative flex items-center justify-center bg-blue-50">
        
        {/* SVG Map Container */}
{/* แก้ไข viewBox: ค่าเดิม "0 0 400 600" -> เปลี่ยนเป็น "90 350 240 130" เพื่อซูมเข้าไปที่จุดที่ path วาดอยู่ */}
<svg viewBox="50 350 220 160" className="w-full h-auto drop-shadow-xl bg-white/50 rounded-lg">
    {/* ========================================== */}
